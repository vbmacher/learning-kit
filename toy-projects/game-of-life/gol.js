...
var _user$project$Board$lives = function (board) {
	var stateToInt = function (s) {
		return s ? 1 : 0;
	};
...
var _user$project$Board$gameStep = function (board) {
	var born = function (n) {
		return _elm_lang$core$Native_Utils.eq(n, 2);
	};
	var survived = function (n) {
		return (_elm_lang$core$Native_Utils.cmp(n, 3) > -1) && (_elm_lang$core$Native_Utils.cmp(n, 5) < 1);
	};
	var getFromMaybe = function (s) {
		var _p0 = s;
		if (_p0.ctor === 'Just') {
			return _p0._0;
		} else {
	...
	var surroundings = function (_p1) {
		var _p2 = _p1;
		var _p4 = _p2._1;
		var _p3 = _p2._0;
		var m = A2(_elm_lang$core$Basics_ops['%'], _p3, 2);
		return {
			ctor: '::',
			_0: {ctor: '_Tuple2', _0: _p3 - 1, _1: _p4 + m},
			_1: {
				ctor: '::',
				_0: {ctor: '_Tuple2', _0: _p3, _1: _p4 + 1},
				_1: {
					ctor: '::',
					_0: {ctor: '_Tuple2', _0: _p3 + 1, _1: _p4 + m},
					_1: {
						ctor: '::',
						_0: {ctor: '_Tuple2', _0: _p3 + 1, _1: (_p4 - 1) + m},
						_1: {
							ctor: '::',
							_0: {ctor: '_Tuple2', _0: _p3, _1: _p4 - 1},
							_1: {
		...
		return _elm_lang$core$List$length(
			A2(
				...
				A2(
					_elm_lang$core$List$map,
					function (s) {
						return A2(_elm_lang$core$Dict$get, s, board);
					},
					surroundings(
						{ctor: '_Tuple2', _0: _p6._0, _1: _p6._1}))));
	};
	var liveness = F3(
		function (board, pos, state) {
...
var _user$project$Board$invertItem = F2(
	function (board, pos) {
		var _p7 = A2(_elm_lang$core$Dict$get, pos, board);
		if (_p7.ctor === 'Just') {
			if (_p7._0 === true) {
				return A3(
					_elm_lang$core$Dict$update,
...
var _user$project$Board$update = F2(
	function (msg, model) {
		var noAction = {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
		var _p10 = msg;
		switch (_p10.ctor) {
			case 'Invert':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							board: A2(_user$project$Board$invertItem, model.board, _p10._0)
						}),
			...
			case 'Tick':
				return model.started ? {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							board: _user$project$Board$gameStep(model.board),
							history: {
								ctor: '::',
								_0: _user$project$Board$lives(model.board),
								_1: model.history
							}
						}),
					_1: _elm_lang$core$Platform_Cmd$none
...
var _user$project$Board$createBoard = F2(
	function (w, h) {
		...
		var states = A2(_elm_lang$core$List$repeat, (w + 1) * (h + 1), false);
		var positions = _elm_lang$core$List$concat(
			A2(
				_elm_lang$core$List$map,
				function (x) {
					return A2(
						...
						A2(_elm_lang$core$List$range, 0, h));
				},
				A2(_elm_lang$core$List$range, 0, w)));
		return _elm_lang$core$Dict$fromList(
			A2(zip, positions, states));
	});
var _user$project$Board$Model = F3(
	function (a, b, c) {
		return {board: a, started: b, history: c};
	});
var _user$project$Board$Noop = {ctor: 'Noop'};
var _user$project$Board$Stop = {ctor: 'Stop'};
var _user$project$Board$Start = {ctor: 'Start'};
var _user$project$Board$Invert = function (a) {
...
var _user$project$Histogram$histoHeight = 200;
var _user$project$Histogram$histoWidth = 200;
var _user$project$Histogram$histogram = function (xs) {
	var len = _elm_lang$core$List$length(xs);
	var xc = function (i) {
		return ((_user$project$Histogram$histoWidth * _elm_lang$core$Basics$toFloat(i)) / _elm_lang$core$Basics$toFloat(len)) - (_user$project$Histogram$histoWidth / 2);
	};
	var series = A3(
		_elm_lang$core$List$map2,
		F2(
		...
		A2(_elm_lang$core$List$range, 0, len),
		xs);
	var max = A3(
		_elm_lang$core$List$foldl,
		F2(
			function (x, a) {
				return (_elm_lang$core$Native_Utils.cmp(x, a) > 0) ? x : a;
			}),
		0,
		xs);
	var yc = function (a) {
		return ((_user$project$Histogram$histoHeight * _elm_lang$core$Basics$toFloat(a)) / _elm_lang$core$Basics$toFloat(max)) - (_user$project$Histogram$histoHeight / 2);
	};
	return _evancz$elm_graphics$Collage$path(
		A2(
			_elm_lang$core$List$map,
...
var _user$project$Styling_ops = _user$project$Styling_ops || {};
_user$project$Styling_ops['=>'] = F2(
	function (v0, v1) {
		return {ctor: '_Tuple2', _0: v0, _1: v1};
	});
var _user$project$Styling$containerStyle = _elm_lang$html$Html_Attributes$style(
	{
		ctor: '::',
		_0: A2(_user$project$Styling_ops['=>'], 'display', 'flex'),
		_1: {
			ctor: '::',
			_0: A2(_user$project$Styling_ops['=>'], 'flex-direction', 'column'),
			_1: {
				ctor: '::',
				_0: A2(_user$project$Styling_ops['=>'], 'padding', '50px'),
				_1: {ctor: '[]'}
			}
		}
	});
var _user$project$Styling$rowStyle = _elm_lang$html$Html_Attributes$style(
	{
		ctor: '::',
		_0: A2(_user$project$Styling_ops['=>'], 'display', 'flex'),
		_1: {
			ctor: '::',
			_0: A2(_user$project$Styling_ops['=>'], 'flex-direction', 'row'),
			_1: {ctor: '[]'}
		}
	});
var _user$project$Styling$chartStyle = _elm_lang$html$Html_Attributes$style(
	{
		ctor: '::',
		_0: A2(_user$project$Styling_ops['=>'], 'border', '1px solid grey'),
		_1: {ctor: '[]'}
	});
var _user$project$Styling$marginTop = function (x) {
	return _elm_lang$html$Html_Attributes$style(
		{
			ctor: '::',
			_0: A2(
				_user$project$Styling_ops['=>'],
				'margin-top',
				A2(
...
var _user$project$View$hexstyle = F2(
	function (_p0, alive) {
		var _p1 = _p0;
		return alive ? _evancz$elm_graphics$Collage$filled(
			A3(_elm_lang$core$Color$rgb, 0, 0, 0)) : _evancz$elm_graphics$Collage$outlined(
			_elm_lang$core$Native_Utils.update(
				_evancz$elm_graphics$Collage$defaultLine,
				{
					width: 3,
					color: A3(_elm_lang$core$Color$rgb, 200, 200, 200)
				}));
	});
var _user$project$View$drawHistogram = function (history) {
	var historyChart = {
		ctor: '::',
		_0: A2(
			_evancz$elm_graphics$Collage$traced,
			_evancz$elm_graphics$Collage$defaultLine,
			_user$project$Histogram$histogram(history)),
		_1: {ctor: '[]'}
	};
	return _evancz$elm_graphics$Element$toHtml(
		A3(_evancz$elm_graphics$Collage$collage, _user$project$Histogram$histoWidth, _user$project$Histogram$histoHeight, historyChart));
};
var _user$project$View$boardItems = {w: 20, h: 10};
var _user$project$View$gap = 20.0;
var _user$project$View$canvasSize = {
	w: (2 * _user$project$View$gap) * _elm_lang$core$Basics$toFloat(_user$project$View$boardItems.w),
	h: (2 * _user$project$View$gap) * _elm_lang$core$Basics$toFloat(_user$project$View$boardItems.h)
};
var _user$project$View$correctY = function (x) {
	return _elm_lang$core$Native_Utils.eq(
		A2(_elm_lang$core$Basics_ops['%'], x, 2),
		0) ? 0 : ((7.0 / 8.0) * _user$project$View$gap);
};
var _user$project$View$toCoord = function (_p2) {
	var _p3 = _p2;
	var _p5 = _p3._0;
	var _p4 = {
		ctor: '_Tuple2',
		_0: _elm_lang$core$Basics$toFloat(_p5),
		_1: _elm_lang$core$Basics$toFloat(_p3._1)
	};
	var x_ = _p4._0;
	var y_ = _p4._1;
	var m = _user$project$View$correctY(_p5);
	return {ctor: '_Tuple2', _0: ((x_ * 1.5) * _user$project$View$gap) - (_user$project$View$canvasSize.w / 2.0), _1: ((((y_ * 1.75) * _user$project$View$gap) + m) - (_user$project$View$canvasSize.h / 2.0)) + _user$project$View$gap};
};
var _user$project$View$toPos = function (mouse) {
	var padding = -50;
	var x = _elm_lang$core$Basics$round(
		(_elm_lang$core$Basics$toFloat(padding + mouse.x) / 1.5) / _user$project$View$gap);
	var m = _user$project$View$correctY(x);
	var y = _elm_lang$core$Basics$round(
		((((_user$project$View$canvasSize.h - _elm_lang$core$Basics$toFloat(mouse.y + padding)) - m) - _user$project$View$gap) / 1.75) / _user$project$View$gap);
	return ((_elm_lang$core$Native_Utils.cmp(x, 0) > -1) && (_elm_lang$core$Native_Utils.cmp(y, 0) > -1)) ? _elm_lang$core$Maybe$Just(
		{ctor: '_Tuple2', _0: x, _1: y}) : _elm_lang$core$Maybe$Nothing;
};
var _user$project$View$clicked = function (mouse) {
	var _p6 = _user$project$View$toPos(mouse);
	if (_p6.ctor === 'Nothing') {
		return _user$project$Board$Noop;
	} else {
		return _user$project$Board$Invert(_p6._0);
	}
};
var _user$project$View$hexagon = F2(
	function (_p7, alive) {
		var _p8 = _p7;
		var _p10 = _p8._1;
		var _p9 = _p8._0;
		var coords = _user$project$View$toCoord(
			{ctor: '_Tuple2', _0: _p9, _1: _p10});
		return A2(
			_evancz$elm_graphics$Collage$move,
			coords,
			A3(
				_user$project$View$hexstyle,
				{ctor: '_Tuple2', _0: _p9, _1: _p10},
				alive,
				A2(_evancz$elm_graphics$Collage$ngon, 6, _user$project$View$gap)));
	});
var _user$project$View$drawBoard = function (board) {
	var hexagonGrid = _elm_lang$core$Dict$values(
		A2(_elm_lang$core$Dict$map, _user$project$View$hexagon, board));
	var iHeight = _elm_lang$core$Basics$round(_user$project$View$canvasSize.h);
	var iWidth = _elm_lang$core$Basics$round(_user$project$View$canvasSize.w);
	return _evancz$elm_graphics$Element$toHtml(
		A3(_evancz$elm_graphics$Collage$collage, iWidth, iHeight, hexagonGrid));
};
var _user$project$View$view = function (model) {
	return A2(
		...
		{
			ctor: '::',
			_0: _user$project$Styling$rowStyle,
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: A2(
				...
				{
					ctor: '::',
					_0: _user$project$Styling$containerStyle,
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
					_0: _user$project$View$drawBoard(model.board),
					_1: {
						ctor: '::',
						_0: A2(
							_elm_lang$html$Html$div,
							{
								ctor: '::',
								_0: _user$project$Styling$marginTop(10),
								_1: {ctor: '[]'}
							},
							{
								ctor: '::',
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html_Events$onClick(_user$project$Board$Start),
										_1: {ctor: '[]'}
									},
									{
										ctor: '::',
								...
								_1: {
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html_Events$onClick(_user$project$Board$Stop),
											_1: {ctor: '[]'}
										},
										{
											ctor: '::',
			...
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _user$project$Styling$chartStyle,
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
						_0: _user$project$View$drawHistogram(model.history),
						_1: {ctor: '[]'}
					}),
				_1: {ctor: '[]'}
			}
...
var _user$project$View$Count2D = F2(
	function (a, b) {
		return {w: a, h: b};
	});
var _user$project$View$Size = F2(
	function (a, b) {
		return {w: a, h: b};
	});
var _user$project$View$Coord = F2(
	function (a, b) {
		return {x: a, y: b};
	});

var _user$project$Main$init = function (items) {
	return {
		board: A2(_user$project$Board$createBoard, items.w, items.h),
		started: false,
		history: {ctor: '[]'}
	};
};
var _user$project$Main$main = _elm_lang$html$Html$program(
	{
		init: {
			ctor: '_Tuple2',
			_0: _user$project$Main$init(_user$project$View$boardItems),
			_1: _elm_lang$core$Platform_Cmd$none
		},
		update: _user$project$Board$update,
		view: _user$project$View$view,
		subscriptions: function (_p0) {
			return _elm_lang$core$Platform_Sub$batch(
				{
					ctor: '::',
					_0: A2(_elm_lang$core$Time$every, _elm_lang$core$Time$second / 4, _user$project$Board$Tick),
					_1: {
						ctor: '::',
						_0: _elm_lang$mouse$Mouse$clicks(_user$project$View$clicked),
						_1: {ctor: '[]'}
					}
				});
		}
